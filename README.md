...
| **Upload conflict queue** | Multi-file uploads with name collisions are handled one at a time. Fixes TFM bug where simultaneous conflict modals would stomp each other, locking the UI. |
